...
export namespace Images {
    ...
    export class TilesetsCatastrophiTiles16 {
        static getName(): string { return 'catastrophi_tiles_16'; }

        static getPNG(): string { return require('assets/tilesets/catastrophi_tiles_16.png'); }
    }
}
